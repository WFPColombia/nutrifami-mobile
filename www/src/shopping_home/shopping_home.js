nutrifamiMobile.controller('ShoppingHomeCtrl', function ($ionicPlatform, $scope, $rootScope, $ionicLoading, $ionicPopup, $location, $timeout, ComprasService, UserService, MediaService) {
    'use strict';
