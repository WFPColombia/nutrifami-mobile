nutrifamiMobile.controller('HomeBuscarCtrl', function($ionicPlatform, $scope, $ionicLoading, $location, $ionicViewSwitcher, $ionicFilterBar, CapacitacionService, UsuarioService) {
    'use strict';
